    ...
    if (typeof bsStepper !== undefined && bsStepper !== null) {
      for (var el = 0; el < bsStepper.length; ++el) {
        bsStepper[el].addEventListener('show.bs-stepper', function (event) {
          ...
          // can't seem to turn off when I press the first item. Â¯\_(ãƒ„)_/Â¯
      ...
      $form.each(function () {
        ...
        $this.validate({
          rules: {
            ...
            shipment_receiver_adress: {
              required: true
            },
            shipment_receiver_tc: {
              required: true
            },
            ...
            shipment_sender_email: {
              required: true
            },
            shipment_sender_adress: {
              required: true
            },
            shipment_sender_tc: {
              required: false
